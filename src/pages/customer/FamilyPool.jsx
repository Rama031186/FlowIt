      ...
      <div className="row g-4 mb-4">
        <div className="col-md-4">
          <div className="stat-card">
            <div className="stat-icon" style={{ background: 'rgba(25,43,55,0.08)', color: '#192b37' }}><FiShield /></div>
            <div className="stat-value">${(pool.totalCoverage / 1000).toFixed(0)}K</div>
            <div className="stat-label">Total Coverage</div>
          </div>
        </div>
        <div className="col-md-4">
          <div className="stat-card">
            <div className="stat-icon" style={{ background: 'rgba(45,156,91,0.1)', color: '#2d9c5b' }}><FiUsers /></div>
            <div className="stat-value">${(pool.allocatedCoverage / 1000).toFixed(0)}K</div>
            <div className="stat-label">Allocated Coverage</div>
          </div>
        </div>
        <div className="col-md-4">
          <div className="stat-card">
            <div className="stat-icon" style={{ background: 'rgba(88,153,196,0.1)', color: '#5899c4' }}><FiUsers /></div>
            <div className="stat-value">{pool.members.length}</div>
